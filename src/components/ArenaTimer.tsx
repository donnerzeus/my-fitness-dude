  ...
  return (
    <div className="arena-timer">
      ...
      <style>{`
        ...
        .current-exercise h3 { font-size: 1.1rem; text-align: center; color: #fff; font-weight: 800; letter-spacing: -0.02em; }
        .main-clock { position: relative; width: 170px; height: 170px; display: flex; align-items: center; justify-content: center; }
        svg.progress-ring { position: absolute; width: 100%; height: 100%; transform: rotate(-90deg); }
        ...
        .time-big { font-size: 3rem; font-weight: 900; color: #fff; line-height: 1; margin-bottom: -5px; }
        .sec-label { font-size: 0.65rem; letter-spacing: 0.3em; color: var(--text-secondary); font-weight: 700; }
        
        @media (max-width: 380px) {
            .main-clock { width: 140px; height: 140px; }
